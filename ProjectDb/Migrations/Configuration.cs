namespace ProjectDb.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ProjectDb.EF.ApplicationDbContext>
    {
        ...
        protected override void Seed(ProjectDb.EF.ApplicationDbContext context)
        {
            ...
            Station s1 = new Station { Name = "Запорожье", ArrivingTime = new DateTime(2019, 11, 1, 14, 15, 0), DepartureTime = new DateTime(2019, 11, 1, 15, 30, 0) };
            Station s2 = new Station { Name = "Харьков", ArrivingTime = new DateTime(2019, 11, 1, 8, 15, 0), DepartureTime = new DateTime(2019, 11, 1, 9, 30, 0) };
            ...
            Station s4 = new Station { Name = "Красноград", ArrivingTime = new DateTime(2019, 11, 1, 10, 25, 0), DepartureTime = new DateTime(2019, 11, 1, 10, 30, 0) };
            ...
            Station s6 = new Station { Name = "Николаев", ArrivingTime = new DateTime(2019, 12, 8, 18, 15, 0), DepartureTime = new DateTime(2019, 12, 8, 18, 30, 0) };
            Station s7 = new Station { Name = "Херсон", ArrivingTime = new DateTime(2019, 12, 8, 15, 15, 0), DepartureTime = new DateTime(2019, 12, 8, 16, 30, 0) };
            ...
            Route r1 = new Route { Stations = new LinkedList<Station>() };
            r1.Stations.AddLast(s2);
            r1.Stations.AddLast(s4);
            r1.Stations.AddLast(s3);
            r1.Stations.AddLast(s1);
            Route r2 = new Route { Stations = new LinkedList<Station>() };
            r2.Stations.AddLast(s7);
            r2.Stations.AddLast(s6);
            r2.Stations.AddLast(s8);

            Route r3 = new Route { Stations = new LinkedList<Station>() };
            r3.Stations.AddLast(s5);
            r3.Stations.AddLast(s9);
            r3.Stations.AddLast(s10);
            ...
            Vagon v7 = new Vagon { Number = 1, Places = 87, Type = "Общий", Train = t3, BusyPaces = 500 };
